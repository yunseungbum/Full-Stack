...
//user는 사용자의 정보, dipatch는 이름을 업데이트하는 함수로 사용할 예정
...
const UserProvider = ({children}) => {
        ...
        //dispatch에다 setName 함수를 전달하여 하위 컴포넌트들도 이름을 업데이트 할 수 있도록 한다.
        const value = {user : {name}, dispatch : setName};


        //UserContext.Provider는 상태나 정보를 제공하는 상자
        //value: 상자에 담을 정보
        //{value}: 그 정보를 실제로 넣은 값
        //{children}: 이 상자 안에 들어갈 내용
